...
TEMPLATE_SOURCE="$HOME/Projects/Hoshock-CFn-Suite/cfn/tmpl/tmpl-data-schedule"

if [ $# -ne 2 ]; then
    echo "Usage: $0 <destination_path> <directory_name>"
    echo "Example: $0 ./cfn my-scheduled-task"
    exit 1
fi
...
echo ""
echo "Next steps:"
echo "  1. Edit template.yaml - Set ScheduleExpression"
